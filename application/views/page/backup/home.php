        ...
        <div class="x_content">
          ...
          <div id="wizard" class="form_wizard wizard_horizontal">
            ...
            <div id="step-1">
              ...
              <p>
              Unggah perlengkapan dokumen seperti Foto, KTP, Ijazah, Transkrip Nilai, Surat Lamaran, CV, dan dokumen pendukung lainnya di Halaman Unggah Berkas. <br><a href="<?=base_url()?>dokumen"> > Klik Disini (Ke Halaman Unggah Berkas)</a>
              </p>
            </div>

            <div id="step-2">
              <h2 class="StepTitle">Cek Daftar Lowongan</h2>
              Daftar lowongan perusahaan jobfair bisa anda lihat di website ini pada tanggal 1 Juni 2020 (H-1 Job Fair) dimulai.<br>
                       ...
                       $no=1;
                         foreach ($perusahaan as $row) {
                          ...
                          <tr>
                            ...
                            <!-- <TR>
                            <TD>#</TD>
                            <td>Daftar lowongan perusahaan jobfair bisa anda lihat di website ini pada tanggal 1 Juni 2020 (H-1 Job Fair) dimulai.</td></TR> -->
                          <?php
                          }
                          ?>  
                         </tbody>
