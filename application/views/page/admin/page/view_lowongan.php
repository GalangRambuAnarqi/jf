  <div class="row">
            <div class="col-md-4 col-sm-4 ">
              <div class="x_panel">
                <div class="x_content">
                <?=$this->session->flashdata('updatelowongan');?>
                <center>
            ...
            <a class="btn btn-success" href='<?=base_url()?>admin/perusahaan/lowongan/?act=edit&id=<?=$lowongan[0]['id']?>' onclick="return confirm('Ingin mengubah lowongan <?=$lowongan[0]['judul_low']?>?')"><i class="fa fa-pencil-square-o"> Edit</i></a>
