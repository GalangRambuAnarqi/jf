          ...
          <table class="table table-hover">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>Pas foto ukuran 3x4 atau 4x6</td>   
                  <td>
                  <?=($cek['exist_foto'])?
                ...
                <tr>
                  ...
                  <td>Scan KTP dalam bentuk PDF</td>     
                  <td>
                  <?=($cek['exist_ktp'])?
                ...
                <tr>
                  ...
                  <td>
                  <input type="file" name="lamaran" id="lamaran" />
                ...
                <tr>
                  ...
                  <td><p class="wrap">CV atau Resume berisi biodata, pengalaman pendidikan / pekerjaan, kemampuan / skill, dll</p></td>     
                  <td>
                  <?=($cek['exist_cv'])?
                ...
                <tr>
                  ...
                  <td>Scan Ijazah terakhir asli / surat keterangan lulus bila ijazah belum muncul</td>    
                  <td>
                  <?=($cek['exist_ijazah'])?
              ...
              <tr>
                ...
                <td>Scan transkrip nilai terakhir asli / daftar nilai bila transkrip asli belum ada</td>         
                <td>
                <?=($cek['exist_transkrip']) ?
